        ...
        for (size_t s = 0; s < shapes.size(); s++) 
        {
            ...
            for (size_t f = 0; f < shapes[s].mesh.num_face_vertices.size(); f++) 
            {
                ...
                for (size_t v = 0; v < fv; v++) 
                {
                    ...
                    indexData.push_back(indexData.size()/*3*idx.vertex_index+0*/);
                    indexData.push_back(indexData.size()/*3*idx.vertex_index+1*/);
                    indexData.push_back(indexData.size()/*3*idx.vertex_index+2*/);
